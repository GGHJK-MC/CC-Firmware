...
function DrawSystem()
    ...
    term.setCursorPos(2, 9) term.write("Firmware Version:  " .. (config.version or "12"))
    term.setCursorPos(2, 10) term.write("GGHJK OS Version:  " .. gosver)
end
...
local function redraw()
    ...
    elseif activePage == "Exit" then DrawExit() end
end
...
local function loading2s()
    ...
    while os.clock() - start < 2 do
        local progress = (os.clock() - start) / 2
