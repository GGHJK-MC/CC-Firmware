                                                                                                        ...
                                                                                                        if p1 == keys.backspace and #input > 0 then
                                                                                                            ...
                                                                                                            elseif p1 == keys.enter then
                                                                                                                ...
                                                                                                                elseif p1 == keys.escape then
                                                                                                                    ...
                                                                                                                    local function findRealIndex(displayItem)
                                                                                                                    for idx, e in ipairs(entries) do
                                                                                                                        if e == displayItem then
                                                                                                                            return idx
                                                                                                                            end
                                                                                                                            end
                                                                                                                            return nil
                                                                                                                            ...
                                                                                                                            if not name or name == "" then return end
                                                                                                                                ...
                                                                                                                                if not path or path == "" then return end
                                                                                                                                    ...
                                                                                                                                    if not prio then
                                                                                                                                        ...
                                                                                                                                        local function renameEntry(displayItem)
                                                                                                                                        local realIdx = findRealIndex(displayItem)
                                                                                                                                        if not realIdx then return end
                                                                                                                                            local e = entries[realIdx]
                                                                                                                                            ...
                                                                                                                                            if not name or name == "" then return end
                                                                                                                                                ...
                                                                                                                                                local function rePathEntry(displayItem)
                                                                                                                                                local realIdx = findRealIndex(displayItem)
                                                                                                                                                if not realIdx then return end
                                                                                                                                                    local e = entries[realIdx]
                                                                                                                                                    ...
                                                                                                                                                    if not path or path == "" then return end
                                                                                                                                                        ...
                                                                                                                                                        local function reprioritizeEntry(displayItem)
                                                                                                                                                        local realIdx = findRealIndex(displayItem)
                                                                                                                                                        if not realIdx then return end
                                                                                                                                                            local e = entries[realIdx]
                                                                                                                                                            ...
                                                                                                                                                            if not prio then
                                                                                                                                                                ...
                                                                                                                                                                local function deleteEntry(displayItem)
                                                                                                                                                                if #entries <= 1 then
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    draw()
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        for i = 1, VISIBLE do
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            if displayList[idx] and (my == y or my == y + 1) then
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                elseif ev == "key" then
                                                                                                                                                                                                                                    local displayList = sortedForDisplay()
                                                                                                                                                                                                                                    local selectedItem = displayList[sel]
                                                                                                                                                                                                                                    if p1 == keys.n then
                                                                                                                                                                                                                                        addEntry()
                                                                                                                                                                                                                                        draw()
                                                                                                                                                                                                                                        elseif p1 == keys.r and selectedItem then
                                                                                                                                                                                                                                            renameEntry(selectedItem)
                                                                                                                                                                                                                                            draw()
                                                                                                                                                                                                                                            elseif p1 == keys.p and selectedItem then
                                                                                                                                                                                                                                                rePathEntry(selectedItem)
                                                                                                                                                                                                                                                draw()
                                                                                                                                                                                                                                                elseif p1 == keys.o and selectedItem then
                                                                                                                                                                                                                                                    reprioritizeEntry(selectedItem)
                                                                                                                                                                                                                                                    draw()
                                                                                                                                                                                                                                                    elseif p1 == keys.delete and selectedItem then
